...
import com.kanonik.cb.databinding.ItemDrinkBinding
...
class DrinkListAdapter(private val drinkListViewModel: DrinkListViewModel) : RecyclerView.Adapter<DrinkListAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ViewHolder {
        val binding: com.kanonik.cb.databinding.ItemDrinkBinding = DataBindingUtil.inflate(LayoutInflater.from(p0.context),
